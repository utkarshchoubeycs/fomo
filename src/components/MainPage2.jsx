...
import section1maskimage from '../assets/section1maskimage-min.png';
import section2bgimage from '../assets/section2bgimage.png';
import section2maskimage from '../assets/section2maskimage-min.png';
    ...
    return (
        <Section
            ...
            <div 
                ...
                style={{
                    opacity: isMaskInView ? 1: 0,
                    transform: isMaskInView ? "none" : "translateX(-50%)",
                    transition: "all 0.8s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s",
                    ...maskImageStyle2
                }}
            >
